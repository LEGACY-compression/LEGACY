...
export RANK=1 # enter the rank of the current node
export DATA='cifar_100_python' # Path to test and training data files
export OUTPUT_DIR='output' # Directoy for output files. 
export DIST_INIT='dist_init1.txt' # Path of torch.distributed distributed init file for rendezvous
...
python run.py --world_size=$world_size --task='resnet18' --seed=1 --reducer=$reducer --rank=${RANK}
##############################
